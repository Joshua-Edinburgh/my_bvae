...
if __name__ == "__main__":
    ...
    parser.add_argument('--max_iter_per_gen', default=1e5, type=int, help='maximum training iteration per generation')
    parser.add_argument('--max_gen', default=1, type=int, help='number of generations')
    ...
    parser.add_argument('--niter_preDE', default=2000, type=int, help='Number of max iterations for pre-train decoder')

    parser.add_argument('--dset_dir', default='data', type=str, help='dataset directory')
    parser.add_argument('--image_size', default=64, type=int, help='image size. now only (64,64) is supported')
    parser.add_argument('--num_workers', default=0, type=int, help='dataloader num_workers')
    
    parser.add_argument('--save_step', default=5e4, type=int, help='number of iterations after which a checkpoint is saved')
    parser.add_argument('--metric_step',default=1e4, type=int, help='number of iterations after which R and top_sim metric saved')
    parser.add_argument('--top_sim_batches',default=500,type=int, help='number of batches of sampling z when calculating top_sim and R')
    parser.add_argument('--save_gifs',default=True, type=str2bool, help='whether save the gifs')

    parser.add_argument('--ckpt_dir', default='checkpoints', type=str, help='checkpoint directory')
    parser.add_argument('--ckpt_name', default='last', type=str, help='load previous checkpoint. insert checkpoint filename')
    parser.add_argument('--exp_name', default='test2', type=str, help='name of the experiment')
...
'''
    ...
    net = Solver(args)
    recon_loss_list, bvae_loss_list = net.interact_train()
'''

#    net = Solver(args)
#    net.net_mode(False)
#    out_z, out_y, out_x = net.gen_z(gen_size=args.nb_preENDE)
#    net.net_mode(True)
